...
# (df_filt will include only blobs with 0.5 <= kT <= 1.0 AND 1.0 <= Si abundance <= 5.0)
df_filt = filterblobs(df,['blob_kT','blob_Si'],minvals=[0.5,1.0],maxvals=[1.0,5.0])
...
IDL> make_map,infile='deconvolution_merged.txt',paramname='blob_kT',paramweights='blob_em',binsize=4.0
